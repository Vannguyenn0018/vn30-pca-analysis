...
with tab1:
    ...
    st.markdown("Dữ liệu được trích xuất từ các tệp CSV lịch sử, đồng bộ hóa và chuyển đổi sang **Log Returns**.")
    ...
    with col_eda2:
        st.subheader("🔗 Ma trận tương quan (Top 10 mã đầu tiên)")
